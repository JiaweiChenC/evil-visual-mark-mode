...
(defcustom evil-visual-mark-show-before-jump t
  "Whether to show marks before jumping to them.
When non-nil, marks will be displayed when you press ' or ` and hidden
after completing the jump or canceling."
  :type 'boolean
  :group 'evil-visual-mark-mode)
